...
int main(int argc, char **argv){
    ...
    ProtobufHelper::printFleetClientMessage(connect.SerializeAsString());
    ...
    ProtobufHelper::printFleetClientMessage(autonomyStatus.SerializeAsString());
    ...
    ProtobufHelper::printFleetServerMessage(watchdogCommand.SerializeAsString());
