...
GPBObjCClassDeclaration(GreenButtonCommand);
GPBObjCClassDeclaration(GreenButtonError);
GPBObjCClassDeclaration(GreenButtonStatus);
GPBObjCClassDeclaration(RedButtonCommand);
GPBObjCClassDeclaration(RedButtonError);
GPBObjCClassDeclaration(RedButtonStatus);
GPBObjCClassDeclaration(SystemLoggerCommand);
GPBObjCClassDeclaration(SystemLoggerError);
GPBObjCClassDeclaration(SystemLoggerStatus);
GPBObjCClassDeclaration(WatchdogCommand);
GPBObjCClassDeclaration(WatchdogError);
GPBObjCClassDeclaration(WatchdogStatus);
...
static GPBFileDescription ActionModuleRoot_FileDescription = {
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(SystemLoggerStatus)
                                   messageName:@"SystemLoggerStatus"
                               fileDescription:&ActionModuleRoot_FileDescription
                                        fields:fields
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(GreenButtonStatus)
                                   messageName:@"GreenButtonStatus"
                               fileDescription:&ActionModuleRoot_FileDescription
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(RedButtonStatus)
                                   messageName:@"RedButtonStatus"
                               fileDescription:&ActionModuleRoot_FileDescription
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(WatchdogStatus)
                                   messageName:@"WatchdogStatus"
                               fileDescription:&ActionModuleRoot_FileDescription
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(SystemLoggerCommand)
                                   messageName:@"SystemLoggerCommand"
                               fileDescription:&ActionModuleRoot_FileDescription
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(GreenButtonCommand)
                                   messageName:@"GreenButtonCommand"
                               fileDescription:&ActionModuleRoot_FileDescription
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(RedButtonCommand)
                                   messageName:@"RedButtonCommand"
                               fileDescription:&ActionModuleRoot_FileDescription
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(WatchdogCommand)
                                   messageName:@"WatchdogCommand"
                               fileDescription:&ActionModuleRoot_FileDescription
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(SystemLoggerError)
                                   messageName:@"SystemLoggerError"
                               fileDescription:&ActionModuleRoot_FileDescription
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(GreenButtonError)
                                   messageName:@"GreenButtonError"
                               fileDescription:&ActionModuleRoot_FileDescription
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(RedButtonError)
                                   messageName:@"RedButtonError"
                               fileDescription:&ActionModuleRoot_FileDescription
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(WatchdogError)
                                   messageName:@"WatchdogError"
                               fileDescription:&ActionModuleRoot_FileDescription
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
