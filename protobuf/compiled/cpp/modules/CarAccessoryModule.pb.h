...
#ifndef GOOGLE_PROTOBUF_INCLUDED_modules_2fCarAccessoryModule_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_modules_2fCarAccessoryModule_2eproto_2epb_2eh
...
PROTOBUF_NAMESPACE_OPEN
template <>
::CarAccessoryModule::ButtonCommand* Arena::CreateMaybeMessage<::CarAccessoryModule::ButtonCommand>(Arena*);
template <>
::CarAccessoryModule::ButtonError* Arena::CreateMaybeMessage<::CarAccessoryModule::ButtonError>(Arena*);
template <>
::CarAccessoryModule::ButtonStatus* Arena::CreateMaybeMessage<::CarAccessoryModule::ButtonStatus>(Arena*);
PROTOBUF_NAMESPACE_CLOSE

namespace CarAccessoryModule {
enum ButtonCommand_Command : int {
  ButtonCommand_Command_PRESS = 0,
  ButtonCommand_Command_ButtonCommand_Command_INT_MIN_SENTINEL_DO_NOT_USE_ =
      std::numeric_limits<::int32_t>::min(),
  ButtonCommand_Command_ButtonCommand_Command_INT_MAX_SENTINEL_DO_NOT_USE_ =
      std::numeric_limits<::int32_t>::max(),
};

bool ButtonCommand_Command_IsValid(int value);
constexpr ButtonCommand_Command ButtonCommand_Command_Command_MIN = static_cast<ButtonCommand_Command>(0);
constexpr ButtonCommand_Command ButtonCommand_Command_Command_MAX = static_cast<ButtonCommand_Command>(0);
constexpr int ButtonCommand_Command_Command_ARRAYSIZE = 0 + 1;
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor*
ButtonCommand_Command_descriptor();
template <typename T>
const std::string& ButtonCommand_Command_Name(T value) {
  static_assert(std::is_same<T, ButtonCommand_Command>::value ||
                    std::is_integral<T>::value,
                "Incorrect type passed to Command_Name().");
  return ButtonCommand_Command_Name(static_cast<ButtonCommand_Command>(value));
}
template <>
inline const std::string& ButtonCommand_Command_Name(ButtonCommand_Command value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfDenseEnum<ButtonCommand_Command_descriptor,
                                                 0, 0>(
      static_cast<int>(value));
}
inline bool ButtonCommand_Command_Parse(absl::string_view name, ButtonCommand_Command* value) {
...
class ButtonCommand final :
 ...
 public:
  ...
  using Command = ButtonCommand_Command;
  static constexpr Command PRESS = ButtonCommand_Command_PRESS;
  static inline bool Command_IsValid(int value) {
    return ButtonCommand_Command_IsValid(value);
  }
  static constexpr Command Command_MIN = ButtonCommand_Command_Command_MIN;
  static constexpr Command Command_MAX = ButtonCommand_Command_Command_MAX;
  static constexpr int Command_ARRAYSIZE = ButtonCommand_Command_Command_ARRAYSIZE;
  ...
  static inline const std::string& Command_Name(T value) {
    return ButtonCommand_Command_Name(value);
  }
...
template <>
struct is_proto_enum<::CarAccessoryModule::ButtonCommand_Command> : std::true_type {};
template <>
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_modules_2fCarAccessoryModule_2eproto_2epb_2eh
