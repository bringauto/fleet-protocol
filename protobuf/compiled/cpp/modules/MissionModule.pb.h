...
#ifndef GOOGLE_PROTOBUF_INCLUDED_modules_2fMissionModule_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_modules_2fMissionModule_2eproto_2epb_2eh
...
PROTOBUF_NAMESPACE_OPEN
template <>
::MissionModule::AutonomyCommand* Arena::CreateMaybeMessage<::MissionModule::AutonomyCommand>(Arena*);
template <>
::MissionModule::AutonomyError* Arena::CreateMaybeMessage<::MissionModule::AutonomyError>(Arena*);
template <>
::MissionModule::AutonomyStatus* Arena::CreateMaybeMessage<::MissionModule::AutonomyStatus>(Arena*);
template <>
::MissionModule::AutonomyStatus_Telemetry* Arena::CreateMaybeMessage<::MissionModule::AutonomyStatus_Telemetry>(Arena*);
template <>
::MissionModule::Position* Arena::CreateMaybeMessage<::MissionModule::Position>(Arena*);
template <>
::MissionModule::Station* Arena::CreateMaybeMessage<::MissionModule::Station>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
inline const std::string& AutonomyStatus_State_Name(AutonomyStatus_State value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfDenseEnum<AutonomyStatus_State_descriptor,
                                                 0, 4>(
...
inline const std::string& AutonomyCommand_Action_Name(AutonomyCommand_Action value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfDenseEnum<AutonomyCommand_Action_descriptor,
                                                 0, 2>(
      static_cast<int>(value));
}
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_modules_2fMissionModule_2eproto_2epb_2eh
