...
PROTOBUF_NAMESPACE_OPEN
template <>
::ExternalProtocol::Command* Arena::CreateMaybeMessage<::ExternalProtocol::Command>(Arena*);
template <>
::ExternalProtocol::CommandResponse* Arena::CreateMaybeMessage<::ExternalProtocol::CommandResponse>(Arena*);
template <>
::ExternalProtocol::Connect* Arena::CreateMaybeMessage<::ExternalProtocol::Connect>(Arena*);
template <>
::ExternalProtocol::ConnectResponse* Arena::CreateMaybeMessage<::ExternalProtocol::ConnectResponse>(Arena*);
template <>
::ExternalProtocol::ExternalClient* Arena::CreateMaybeMessage<::ExternalProtocol::ExternalClient>(Arena*);
template <>
::ExternalProtocol::ExternalServer* Arena::CreateMaybeMessage<::ExternalProtocol::ExternalServer>(Arena*);
template <>
::ExternalProtocol::Status* Arena::CreateMaybeMessage<::ExternalProtocol::Status>(Arena*);
template <>
::ExternalProtocol::StatusResponse* Arena::CreateMaybeMessage<::ExternalProtocol::StatusResponse>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
inline const std::string& ConnectResponse_Type_Name(ConnectResponse_Type value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfDenseEnum<ConnectResponse_Type_descriptor,
                                                 0, 1>(
...
inline const std::string& Status_DeviceState_Name(Status_DeviceState value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfDenseEnum<Status_DeviceState_descriptor,
                                                 0, 3>(
      static_cast<int>(value));
}
...
inline const std::string& StatusResponse_Type_Name(StatusResponse_Type value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfDenseEnum<StatusResponse_Type_descriptor,
                                                 0, 0>(
      static_cast<int>(value));
}
...
constexpr CommandResponse_Type CommandResponse_Type_Type_MAX = static_cast<CommandResponse_Type>(1);
constexpr int CommandResponse_Type_Type_ARRAYSIZE = 1 + 1;
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor*
...
inline const std::string& CommandResponse_Type_Name(CommandResponse_Type value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfDenseEnum<CommandResponse_Type_descriptor,
                                                 0, 1>(
      static_cast<int>(value));
}
...
class Connect final :
 ...
 public:
  ...
  void set_allocated_vehiclename(std::string* ptr);
...
class Status final :
 ...
 public:
  ...
  static inline const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* DeviceState_descriptor() {
...
inline PROTOBUF_ALWAYS_INLINE void Connect::set_vehiclename(Arg_&& arg,
                                                     Args_... args) {
  ;
  _impl_.vehiclename_.Set(static_cast<Arg_&&>(arg), args..., GetArenaForAllocation());
...
inline void Connect::set_allocated_vehiclename(std::string* value) {
  _impl_.vehiclename_.SetAllocated(value, GetArenaForAllocation());
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
inline PROTOBUF_ALWAYS_INLINE void Status::set_errormessage(Arg_&& arg,
                                                     Args_... args) {
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.errormessage_.SetBytes(static_cast<Arg_&&>(arg), args..., GetArenaForAllocation());
