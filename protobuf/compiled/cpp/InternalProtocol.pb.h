...
PROTOBUF_NAMESPACE_OPEN
template <>
::InternalProtocol::Device* Arena::CreateMaybeMessage<::InternalProtocol::Device>(Arena*);
template <>
::InternalProtocol::DeviceCommand* Arena::CreateMaybeMessage<::InternalProtocol::DeviceCommand>(Arena*);
template <>
::InternalProtocol::DeviceConnect* Arena::CreateMaybeMessage<::InternalProtocol::DeviceConnect>(Arena*);
template <>
::InternalProtocol::DeviceConnectResponse* Arena::CreateMaybeMessage<::InternalProtocol::DeviceConnectResponse>(Arena*);
template <>
::InternalProtocol::DeviceStatus* Arena::CreateMaybeMessage<::InternalProtocol::DeviceStatus>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
inline const std::string& DeviceConnectResponse_ResponseType_Name(DeviceConnectResponse_ResponseType value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfDenseEnum<DeviceConnectResponse_ResponseType_descriptor,
                                                 0, 4>(
...
constexpr Device_Module Device_Module_Module_MAX = static_cast<Device_Module>(999);
constexpr int Device_Module_Module_ARRAYSIZE = 999 + 1;
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor*
...
const std::string& Device_Module_Name(T value) {
  ...
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(Device_Module_descriptor(), value);
}
...
class DeviceStatus final :
 ...
 public:
  ...
  void set_allocated_statusdata(std::string* ptr);
...
class DeviceCommand final :
 ...
 public:
  ...
  void set_allocated_commanddata(std::string* ptr);
...
class Device final :
 ...
 public:
  ...
  static constexpr Module CAR_ACCESSORY_MODULE = Device_Module_CAR_ACCESSORY_MODULE;
  ...
  static inline const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* Module_descriptor() {
  ...
  void set_allocated_devicerole(std::string* ptr);
...
inline PROTOBUF_ALWAYS_INLINE void DeviceStatus::set_statusdata(Arg_&& arg,
                                                     Args_... args) {
  ;
  _impl_.statusdata_.SetBytes(static_cast<Arg_&&>(arg), args..., GetArenaForAllocation());
...
inline void DeviceStatus::set_allocated_statusdata(std::string* value) {
  _impl_.statusdata_.SetAllocated(value, GetArenaForAllocation());
...
inline PROTOBUF_ALWAYS_INLINE void DeviceCommand::set_commanddata(Arg_&& arg,
                                                     Args_... args) {
  ;
  _impl_.commanddata_.SetBytes(static_cast<Arg_&&>(arg), args..., GetArenaForAllocation());
...
inline void DeviceCommand::set_allocated_commanddata(std::string* value) {
  _impl_.commanddata_.SetAllocated(value, GetArenaForAllocation());
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
inline PROTOBUF_ALWAYS_INLINE void Device::set_devicerole(Arg_&& arg,
                                                     Args_... args) {
  ;
  _impl_.devicerole_.Set(static_cast<Arg_&&>(arg), args..., GetArenaForAllocation());
...
inline void Device::set_allocated_devicerole(std::string* value) {
  _impl_.devicerole_.SetAllocated(value, GetArenaForAllocation());
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
