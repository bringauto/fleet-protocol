...
type ExternalServer_ConnectResponse struct {
	ConnectResponse *ConnectResponse `protobuf:"bytes,1,opt,name=connectResponse,oneof"`
}

type ExternalServer_StatusResponse struct {
	StatusResponse *StatusResponse `protobuf:"bytes,2,opt,name=statusResponse,oneof"`
}

type ExternalServer_Command struct {
	Command *Command `protobuf:"bytes,3,opt,name=command,oneof"`
}
...
type ExternalClient_Connect struct {
	Connect *Connect `protobuf:"bytes,1,opt,name=connect,oneof"`
}
...
type ExternalClient_CommandResponse struct {
	CommandResponse *CommandResponse `protobuf:"bytes,3,opt,name=commandResponse,oneof"`
}
...
type Connect struct {
	...
	// Car name
	VehicleName string `protobuf:"bytes,3,opt,name=vehicleName" json:"vehicleName,omitempty"`
...
type ConnectResponse struct {
	...
	SessionId string               `protobuf:"bytes,1,opt,name=sessionId" json:"sessionId,omitempty"`
	Type      ConnectResponse_Type `protobuf:"varint,2,opt,name=type,enum=ExternalProtocol.ConnectResponse_Type" json:"type,omitempty"`
}
...
type Status struct {
	...
	DeviceState Status_DeviceState `protobuf:"varint,2,opt,name=deviceState,enum=ExternalProtocol.Status_DeviceState" json:"deviceState,omitempty"`
	// *
	// Message ID
	MessageCounter uint32 `protobuf:"varint,3,opt,name=messageCounter" json:"messageCounter,omitempty"`
	// *
	// Device specific status message, containing device information and status data
	DeviceStatus *DeviceStatus `protobuf:"bytes,4,opt,name=deviceStatus" json:"deviceStatus,omitempty"`
	// *
	// Device specific error message
	ErrorMessage []byte `protobuf:"bytes,5,opt,name=errorMessage" json:"errorMessage,omitempty"`
}
...
type StatusResponse struct {
	...
	SessionId      string              `protobuf:"bytes,1,opt,name=sessionId" json:"sessionId,omitempty"`
	Type           StatusResponse_Type `protobuf:"varint,2,opt,name=type,enum=ExternalProtocol.StatusResponse_Type" json:"type,omitempty"`
	MessageCounter uint32              `protobuf:"varint,3,opt,name=messageCounter" json:"messageCounter,omitempty"`
}
...
type Command struct {
	...
	SessionId      string `protobuf:"bytes,1,opt,name=sessionId" json:"sessionId,omitempty"`
	MessageCounter uint32 `protobuf:"varint,2,opt,name=messageCounter" json:"messageCounter,omitempty"`
	// *
	// command binary data and target device
	DeviceCommand *DeviceCommand `protobuf:"bytes,3,opt,name=deviceCommand" json:"deviceCommand,omitempty"`
}
...
type CommandResponse struct {
	...
	SessionId      string               `protobuf:"bytes,1,opt,name=sessionId" json:"sessionId,omitempty"`
	Type           CommandResponse_Type `protobuf:"varint,2,opt,name=type,enum=ExternalProtocol.CommandResponse_Type" json:"type,omitempty"`
	MessageCounter uint32               `protobuf:"varint,3,opt,name=messageCounter" json:"messageCounter,omitempty"`
}
...
var file_ExternalProtocol_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	,
...
var file_ExternalProtocol_proto_goTypes = []any{
...
func file_ExternalProtocol_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_ExternalProtocol_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_ExternalProtocol_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_ExternalProtocol_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_ExternalProtocol_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_ExternalProtocol_proto_msgTypes[4].Exporter = func(v any, i int) any {
			switch v := v.(*Status); i {
			case 0:
				return &v.state
			case 1:
		...
		file_ExternalProtocol_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_ExternalProtocol_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_ExternalProtocol_proto_msgTypes[7].Exporter = func(v any, i int) any {
	...
	file_ExternalProtocol_proto_msgTypes[0].OneofWrappers = []any{
		(*ExternalServer_ConnectResponse)(nil),
		(*ExternalServer_StatusResponse)(nil),
		(*ExternalServer_Command)(nil),
	}
	file_ExternalProtocol_proto_msgTypes[1].OneofWrappers = []any{
