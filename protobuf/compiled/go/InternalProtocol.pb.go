...
const (
	...
	Device_IO_MODULE Device_Module = 2
	// / First additional module, can be changed
	Device_EXAMPLE_MODULE Device_Module = 1000
)
...
type InternalClient_DeviceConnect struct {
	DeviceConnect *DeviceConnect `protobuf:"bytes,1,opt,name=deviceConnect,oneof"`
}

type InternalClient_DeviceStatus struct {
	DeviceStatus *DeviceStatus `protobuf:"bytes,2,opt,name=deviceStatus,oneof"`
}
...
type InternalServer_DeviceConnectResponse struct {
	DeviceConnectResponse *DeviceConnectResponse `protobuf:"bytes,1,opt,name=deviceConnectResponse,oneof"`
}

type InternalServer_DeviceCommand struct {
	DeviceCommand *DeviceCommand `protobuf:"bytes,2,opt,name=deviceCommand,oneof"`
}
...
type DeviceConnectResponse struct {
	...
	ResponseType DeviceConnectResponse_ResponseType `protobuf:"varint,1,opt,name=responseType,enum=InternalProtocol.DeviceConnectResponse_ResponseType" json:"responseType,omitempty"`
...
type DeviceStatus struct {
	...
	Device     *Device `protobuf:"bytes,1,opt,name=device" json:"device,omitempty"`
	StatusData []byte  `protobuf:"bytes,2,opt,name=statusData" json:"statusData,omitempty"`
}
...
type DeviceCommand struct {
	...
	Device      *Device `protobuf:"bytes,1,opt,name=device" json:"device,omitempty"`
	CommandData []byte  `protobuf:"bytes,2,opt,name=commandData" json:"commandData,omitempty"`
}
...
type Device struct {
	...
	Module Device_Module `protobuf:"varint,1,opt,name=module,enum=InternalProtocol.Device_Module" json:"module,omitempty"`
	...
	DeviceRole string `protobuf:"bytes,3,opt,name=deviceRole" json:"deviceRole,omitempty"`
	// device name
...
var file_InternalProtocol_proto_rawDesc = []byte{
	...
	0x63, 0x65, 0x52, 0x06, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x22, 0xb5, 0x02, 0x0a, 0x15, 0x44,
	0x65, 0x76, 0x69, 0x63, 0x65, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x5f, 0x0a, 0x0c, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	...
	0x42, 0x05, 0xaa, 0x01, 0x02, 0x08, 0x02, 0x52, 0x0c, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	0x65, 0x54, 0x79, 0x70, 0x65, 0x12, 0x30, 0x0a, 0x06, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x49, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c,
	0x50, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x2e, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x52,
	0x06, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x22, 0x88, 0x01, 0x0a, 0x0c, 0x52, 0x65, 0x73, 0x70,
	...
	,
	...
	0x62, 0x61, 0x5f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x08, 0x65, 0x64, 0x69, 0x74, 0x69, 0x6f,
...
var file_InternalProtocol_proto_goTypes = []any{
...
func file_InternalProtocol_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_InternalProtocol_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_InternalProtocol_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_InternalProtocol_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_InternalProtocol_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_InternalProtocol_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_InternalProtocol_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_InternalProtocol_proto_msgTypes[6].Exporter = func(v any, i int) any {
			switch v := v.(*Device); i {
			case 0:
				return &v.state
			case 1:
	...
	file_InternalProtocol_proto_msgTypes[0].OneofWrappers = []any{
		(*InternalClient_DeviceConnect)(nil),
		(*InternalClient_DeviceStatus)(nil),
	}
	file_InternalProtocol_proto_msgTypes[1].OneofWrappers = []any{
